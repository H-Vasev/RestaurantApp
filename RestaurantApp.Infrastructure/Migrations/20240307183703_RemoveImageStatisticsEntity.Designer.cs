...
namespace RestaurantApp.Infrastructure.Migrations
{
    ...
    [Migration("20240307183703_RemoveImageStatisticsEntity")]
    partial class RemoveImageStatisticsEntity
    {
            ...
            modelBuilder.Entity("RestaurantApp.Infrastructure.Data.Models.GalleryImage", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2024, 3, 7, 18, 37, 2, 549, DateTimeKind.Local).AddTicks(8842),
                            ImagePaht = "img/gallery/gallery-1.jpg"
                        },
                        new
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2024, 3, 6, 18, 37, 2, 549, DateTimeKind.Local).AddTicks(8848),
                            ImagePaht = "img/gallery/gallery-2.jpg"
                        },
                        new
                        {
                            Id = 3,
                            CreatedOn = new DateTime(2024, 3, 5, 18, 37, 2, 549, DateTimeKind.Local).AddTicks(8850),
                            ImagePaht = "img/gallery/gallery-3.jpg"
                        },
                        new
                        {
                            Id = 4,
                            CreatedOn = new DateTime(2024, 3, 4, 18, 37, 2, 549, DateTimeKind.Local).AddTicks(8852),
                            ImagePaht = "img/gallery/gallery-4.jpg"
                        },
                        new
                        {
                            Id = 5,
                            CreatedOn = new DateTime(2024, 3, 3, 18, 37, 2, 549, DateTimeKind.Local).AddTicks(8853),
                            ImagePaht = "img/gallery/gallery-5.jpg"
                        },
                        new
                        {
                            Id = 6,
                            CreatedOn = new DateTime(2024, 3, 2, 18, 37, 2, 549, DateTimeKind.Local).AddTicks(8855),
                            ImagePaht = "img/gallery/gallery-6.jpg"
                        },
                        new
                        {
                            Id = 7,
                            CreatedOn = new DateTime(2024, 3, 1, 18, 37, 2, 549, DateTimeKind.Local).AddTicks(8857),
                            ImagePaht = "img/gallery/gallery-7.jpg"
                        },
                        new
                        {
                            Id = 8,
                            CreatedOn = new DateTime(2024, 2, 29, 18, 37, 2, 549, DateTimeKind.Local).AddTicks(8858),
